    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <main class="flex-1 overflow-y-auto p-3 lg:p-6">
        <div class="max-w-2xl mx-auto">
          <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Pengaturan</h1>
          <p class="text-gray-500 dark:text-gray-400 mb-8">Kelola profil dan akun Anda</p>

          <!-- Profile Card -->
          <div class="card dark:bg-gray-800 dark:border-gray-700 p-6 mb-6">
            <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Profil</h2>
            <div class="space-y-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Username</label>
                <input :value="authStore.user?.username || ''" type="text" class="input-field bg-gray-50 dark:bg-gray-700" disabled />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Nama</label>
                <input :value="authStore.user?.name || ''" type="text" class="input-field bg-gray-50 dark:bg-gray-700" disabled />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Role</label>
                <input :value="authStore.user?.role || 'user'" type="text" class="input-field bg-gray-50 dark:bg-gray-700" disabled />
              </div>
            </div>
          </div>
          ...
          <div class="card dark:bg-gray-800 dark:border-gray-700 p-6 mb-6">
            <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Ubah Password</h2>
            ...
            <form @submit.prevent="handleChangePassword" class="space-y-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Password Lama <span class="text-red-500">*</span></label>
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Konfirmasi Password Baru <span class="text-red-500">*</span></label>
          ...
          <div class="card dark:bg-gray-800 dark:border-gray-700 p-6">
            <button @click="handleLogout" class="w-full py-3 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 font-medium rounded-xl hover:bg-red-100 dark:hover:bg-red-900/50 transition-colors">
              Logout
            </button>
          </div>
        </div>
